      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            <Hammer className="h-12 w-12 text-teal-600 mx-auto mb-4" />
            <h3 className="text-xl font-semibold mb-2">Real asks, not busywork</h3>
            <p className="text-gray-600">Builders post specific roles on real projects, not a decorative "looking for" tag</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            <Sparkles className="h-12 w-12 text-teal-600 mx-auto mb-4" />
            <h3 className="text-xl font-semibold mb-2">No experience floor</h3>
            <p className="text-gray-600">Anyone can join as a Supporter and apply — there's no gate to get in the door</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            <BadgeCheck className="h-12 w-12 text-teal-600 mx-auto mb-4" />
            <h3 className="text-xl font-semibold mb-2">A record that means something</h3>
            <p className="text-gray-600">Every credential is named and attributable, not a self-reported resume bullet</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border-t border-gray-200 py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <p className="text-sm font-semibold text-teal-600 uppercase tracking-wide mb-2">Part of the Greyin ecosystem</p>
