...
const STATUS_STYLES: Record<string, string> = {
  ...
  idea: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-950/40 dark:text-yellow-400',
}
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="bg-gradient-to-r from-teal-600 to-emerald-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link
            href="/projects/new"
            className="inline-flex items-center gap-2 bg-white text-teal-600 px-8 py-4 rounded-lg hover:bg-gray-100 font-bold text-lg dark:bg-gray-900 dark:text-teal-400 dark:hover:bg-gray-800"
          >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <p className="text-gray-600 mb-6 dark:text-gray-400">{projects?.length || 0} projects</p>
        ...
        {projects && projects.length > 0 ? (
          <div className="space-y-6">
            {projects.map((project: any) => {
              ...
              return (
                <div key={project.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition dark:bg-gray-900">
                  <div className="flex items-center gap-3 mb-2 flex-wrap">
                    <Link href={`/projects/${project.id}`} className="text-2xl font-bold text-gray-900 hover:text-teal-600 dark:text-gray-50">
                      {project.title}
                    </Link>
                    ...
                    {openAsks > 0 && (
                      <span className="flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold bg-teal-50 text-teal-700 dark:bg-teal-950/40 dark:text-teal-400">
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center dark:bg-gray-900">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2 dark:text-gray-50">No projects yet</h3>
            <p className="text-gray-600 dark:text-gray-400">Be the first Builder to post one</p>
          </div>
        )}
      </div>
    </main>
