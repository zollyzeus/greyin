    ...
    >
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6 dark:bg-gray-900">
          ...
          {greyinScoreRow?.greyin_score != null && (
            <details className="mb-4 pb-4 border-b border-gray-100 dark:border-gray-800">
              <summary className="text-xs font-medium text-teal-600 cursor-pointer select-none dark:text-teal-400">How is this calculated?</summary>
          ...
          {outcomes && outcomes.length > 0 ? (
            <div className="divide-y">
              {outcomes.map((o: any) => (
                <div key={o.id} className="py-3">
                  ...
                  {o.ai_score !== null && (
                    <p className="text-xs text-gray-500 dark:text-gray-400">AI: {o.ai_score}/100{o.ai_notes ? ` — ${o.ai_notes}` : ''}</p>
                  )}
                  {o.human_score !== null && (
                    <p className="text-xs text-gray-500 dark:text-gray-400">Reviewer: {o.human_score}/100{o.human_notes ? ` — ${o.human_notes}` : ''}</p>
                  )}
                </div>
              ))}
            </div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <Link href="/projects" className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300">Projects</Link> to start building your track record.
            </p>
          )}
        </div>
              ...
              <div>
                <label className="flex items-center">
                  <input
                    ...
                    className="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500 dark:text-indigo-400 dark:bg-gray-950 dark:text-gray-100"
                  />
