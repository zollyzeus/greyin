    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-emerald-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-8">
          <a href="https://greyin.net" className="inline-flex items-center gap-2 text-3xl font-bold text-teal-600">
            <FlaskConical className="w-8 h-8" />
            <span>StackWorks</span>
          </a>
          <h2 className="font-display mt-4 text-2xl font-semibold text-gray-900">Create your account</h2>
          <p className="mt-2 text-sm text-gray-600">Build with senior peers, earn a verified record</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <label className="relative flex flex-col items-center justify-center p-6 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-teal-500 hover:bg-teal-50 transition-all">
              <input
                type="radio"
                name="track"
                value="builder"
              ...
              />
              <Hammer className="w-12 h-12 text-gray-400 peer-checked:text-teal-600 mb-3" />
              <span className="text-lg font-medium text-gray-700 peer-checked:text-teal-600">
                Post a project
              </span>
              <span className="text-sm text-gray-500 mt-1 text-center">As a Builder — senior-level experience required</span>
            ...
            <label className="relative flex flex-col items-center justify-center p-6 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-teal-500 hover:bg-teal-50 transition-all">
              <input
                ...
                className="sr-only peer"
              />
              <Sparkles className="w-12 h-12 text-gray-400 peer-checked:text-teal-600 mb-3" />
              <span className="text-lg font-medium text-gray-700 peer-checked:text-teal-600">
                Help build one
              </span>
              <span className="text-sm text-gray-500 mt-1 text-center">As a Supporter — any experience level</span>
              <div className="absolute inset-0 border-2 border-transparent peer-checked:border-teal-600 rounded-xl pointer-events-none" />
            </label>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Link
                href="/login"
                className="w-full flex justify-center py-3 px-4 border border-teal-600 rounded-lg shadow-sm text-sm font-medium text-teal-600 bg-white hover:bg-teal-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors"
              >
                Sign in instead
              </Link>
            </div>
