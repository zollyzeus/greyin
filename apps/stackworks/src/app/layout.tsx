...
// own comment for the full rationale. Same pairing everywhere: Newsreader
// for display/headline text, Inter for body/UI, each app keeping its own
// PILLARS accent color.
const newsreader = Newsreader({ subsets: ['latin'], variable: '--font-display', weight: ['500', '600'] })
const inter = Inter({ subsets: ['latin'], variable: '--font-sans' })

export const metadata = {
  title: 'StackWorks - Build with senior peers, earn a verified record',
  description: 'Senior Builders post real project asks; Supporters apply, do the work, and earn a verified, named record of what they shipped.',
}
