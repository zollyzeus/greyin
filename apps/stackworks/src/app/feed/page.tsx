...
import { FlaskConical, ArrowLeft, Rss } from 'lucide-react'
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 mb-6">
          <Rss className="h-6 w-6 text-teal-600 dark:text-teal-400" />
        ...
        {items && items.length > 0 ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center dark:bg-gray-900">
            ...
            <p className="text-gray-600 mb-4 dark:text-gray-400">Follow people from the People directory to see their activity here.</p>
            <Link href="/people" className="text-teal-600 font-semibold hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300">
              Browse People &rarr;
            </Link>
          </div>
        )}
