      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {items && items.length > 0 ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <p className="text-gray-600 mb-4">Follow people from the People directory to see their activity here.</p>
            <Link href="/people" className="text-teal-600 font-semibold hover:text-teal-700">
              Browse People &rarr;
            </Link>
          </div>
        )}
