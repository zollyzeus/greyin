    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-6 text-gray-700 dark:bg-gray-900 dark:text-gray-300">
          <section>
            <h2 className="font-semibold text-gray-900 mb-2 dark:text-gray-50">Using StackWorks</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 mb-2 dark:text-gray-50">Verified outcomes</h2>
            <p>
          ...
          <section>
            ...
            <p>Reach out to <a href="mailto:admin@greyin.net" className="text-teal-600 hover:underline dark:text-teal-400">admin@greyin.net</a> with any questions about these terms.</p>
          </section>
        </div>
      </div>
    </main>
