...
function RailContents({ builder, isAdmin, activeSection, userName, verified, greyinScore, onNavigate, onOpenFeedback, onLogNav, onLogPillarSwitch }: {
  builder?: boolean
  isAdmin?: boolean
  activeSection?: string
  userName: string
    ...
    <>
      <div className="flex items-center gap-2 px-5 h-16 border-b border-gray-200 dark:border-gray-800 shrink-0">
        <a href="https://greyin.net" className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-gray-900 dark:text-gray-50">StackWorks</span>
        </a>
      </div>
      ...
      <div className="border-t border-gray-200 p-3 space-y-2 shrink-0 dark:border-gray-800">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5">
          <div className="h-8 w-8 rounded-full bg-teal-100 text-teal-700 dark:bg-teal-950 dark:text-teal-400 flex items-center justify-center text-xs font-semibold shrink-0">
