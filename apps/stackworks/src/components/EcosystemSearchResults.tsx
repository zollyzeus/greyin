 ...
 * apps. StackWorks was a search-index source (builder_projects, since 037)
 * but never had a search UI of its own to consume the other four
 * pillars' content — this closes that gap, matching the identical
 * component already present in the other 4 apps.
 */
