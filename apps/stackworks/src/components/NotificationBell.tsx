            ...
            <div className="flex items-center justify-between px-4 py-2 border-b dark:border-gray-800">
              ...
              {unreadCount > 0 && (
                <button
                  ...
                  className="text-xs font-medium text-teal-600 dark:text-teal-400 hover:opacity-80"
                >
                  Mark all read
                </button>
              )}
            ...
            {items.length > 0 ? (
              <div className="divide-y dark:divide-gray-800 max-h-96 overflow-y-auto">
                {items.map((n) => {
                  ...
                  const body = (
                    <div className={`px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 ${n.read ? '' : 'bg-teal-50/60 dark:bg-teal-950/20'}`}>
      ...
      {toastItem && (
        ...
        >
          <div className="flex items-start gap-3">
            <Bell className="h-5 w-5 text-teal-600 dark:text-teal-400 shrink-0 mt-0.5" />
