    ...
    >
        <div className="bg-white rounded-2xl shadow-xl p-8 dark:bg-gray-900">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm text-center text-2xl tracking-[0.5em] focus:outline-none focus:ring-purple-500 focus:border-purple-500 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100"
                placeholder="000000"
              />
            </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/reset-password" className="text-purple-600 hover:text-purple-500 font-medium dark:text-purple-400">
              Request a new one
            </Link>
          </p>
        </div>
