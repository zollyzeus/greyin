    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-6 text-gray-700">
          ...
          <section>
            <h2 className="font-semibold text-gray-900 mb-2">Anonymous posting</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              {' '}<a href="mailto:admin@greyin.net" className="text-purple-600 hover:underline">admin@greyin.net</a>.
            </p>
          </section>
        </div>
      </div>
