          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            {replyQualityCount > 0 && (
              <div className="mt-4 pt-4 border-t border-gray-100 text-sm">
                <p className="text-gray-500">AI mentoring quality (this platform, informational only)</p>
                <p className="font-semibold text-gray-900">{replyQualityCount} scored repl{replyQualityCount === 1 ? 'y' : 'ies'} · avg {replyQualityAvg}/100</p>
              </div>
            )}
