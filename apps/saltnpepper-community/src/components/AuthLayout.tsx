 ...
 * background wash) so it still reads as Salt & Pepper, not a generic
 * form. Same props as before, so the 5 auth pages consuming it are
 * unchanged.
 */
export function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-gray-950 dark:via-gray-950 dark:to-gray-900">
      <div className={wide ? 'max-w-2xl w-full' : 'max-w-md w-full'}>
        <div className="text-center mb-8">
          <a
            href="https://greyin.net"
            className="inline-flex items-center gap-2 text-2xl font-bold text-purple-600 dark:text-purple-400"
          >
