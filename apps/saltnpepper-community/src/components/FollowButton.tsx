 ...
 * (053_activity_feed.sql). Mirrors the existing Message button's
 * form-POST-with-hidden-target-id pattern (members/page.tsx).
 */
      ...
      <button
        ...
        className={
          isFollowing
            ...
            : 'flex items-center gap-1.5 text-sm font-medium text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300'
        }
      >
