    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Pivoting</h1>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow p-6 flex gap-4">
            ...
            <div>
              <h2 className="font-semibold text-gray-900 mb-1">2. Build a track record on StackWorks</h2>
              <p className="text-gray-600 text-sm mb-3">
        ...
        <div className="mt-10 text-center">
          <a href="https://deepedge.greyin.net/jobs" className="text-sm font-semibold text-orange-700 inline-flex items-center gap-1">
