...
export default async function LoginPage({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-cyan-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2">
            <Image src="/logo.png" alt="" width={32} height={32} className="w-8 h-8" priority />
            <Image src="/GreyIn.png" alt="Greyin" width={150} height={24} className="h-6 w-auto" priority />
          </Link>
          <h2 className="font-display mt-4 text-2xl font-semibold text-gray-900">Welcome back</h2>
          <p className="mt-2 text-sm text-gray-600">Sign in to your ecosystem dashboard</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form action="/auth/login" method="POST" className="space-y-6">
            ...
            <div className="flex items-center justify-end">
              <a href="https://deepedge.greyin.net/reset-password" className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                Forgot password?
              </a>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to Greyin?</span>
              </div>
            </div>
