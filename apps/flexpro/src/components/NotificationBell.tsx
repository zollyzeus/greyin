    ...
    <>
      <div className="relative">
        <button
          ...
          className="relative p-2 text-gray-700 hover:text-orange-600 dark:text-gray-300"
        ...
        {open && (
          <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-50 dark:bg-gray-900 dark:border-gray-800">
            <div className="flex items-center justify-between px-4 py-2 border-b dark:border-gray-800">
              ...
              {unreadCount > 0 && (
                <button
                  ...
                  className="text-xs font-medium text-orange-600 dark:text-orange-400 hover:opacity-80"
                >
                  Mark all read
                </button>
              )}
            ...
            {items.length > 0 ? (
              <div className="divide-y dark:divide-gray-800 max-h-96 overflow-y-auto">
                {items.map((n) => {
                  ...
                  const body = (
                    <div className={`px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 ${n.read ? '' : 'bg-orange-50/60 dark:bg-orange-950/20'}`}>
            ...
            <Link
              ...
              className="block text-center text-sm font-medium text-orange-600 py-2.5 border-t hover:bg-gray-50 dark:text-orange-400 dark:hover:bg-gray-800"
            >
              View all
            </Link>
          </div>
      ...
      {toastItem && (
        ...
        >
          <div className="flex items-start gap-3">
            <Bell className="h-5 w-5 text-orange-600 dark:text-orange-400 shrink-0 mt-0.5" />
