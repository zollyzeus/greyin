...
// before this (the homepage's own "One login, five more platforms"
// promo section is separate, homepage-only content, not a footer).
// Mounted once in layout.tsx so it's on every route. Same shape as every
// other pillar app's own new footer: brand + tagline, app-specific nav
// links, a cross-pillar row, copyright.
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-white">FlexPro</span>
            </div>
            <p className="text-sm">Find and hire talented freelancers, or find your next project.</p>
          </div>
          <div>
            <h3 className="text-white font-semibold mb-4">Explore</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="/gigs" className="hover:text-white transition">Browse Gigs</Link></li>
              <li><Link href="/gigs/new" className="hover:text-white transition">Become a Seller</Link></li>
        ...
        <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-3 text-sm border-t border-gray-800 mt-8 pt-8">
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
            ...
            <a href="https://greyin.net/feedback?app=flexpro" className="hover:text-white transition">Feedback</a>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-3 text-sm border-t border-gray-800 mt-6 pt-6">
          ...
          <a href="https://greyin.net/feedback?app=flexpro" className="hover:text-white transition">Contact</a>
        </div>
      </div>
    </footer>
  )
