    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white border-b border-gray-200">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/client-jobs" className="flex items-center gap-2 text-gray-600 hover:text-orange-600">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-600 mb-6">Describe what you need done. Verified experts apply, you pick who does the work.</p>
          ...
          {subscription?.status !== 'active' ? (
            ...
            <form action="/api/client-jobs/create" method="POST" className="space-y-6">
              ...
              <div>
                <label htmlFor="budget_amount" className="block text-sm font-medium text-gray-700">Budget (₹, optional)</label>
