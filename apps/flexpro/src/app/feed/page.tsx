  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Link href="/dashboard" className="flex items-center text-gray-600 hover:text-orange-600 mb-6 dark:text-gray-400">
        ...
        {items && items.length > 0 ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center dark:bg-gray-900">
            ...
            <p className="text-gray-600 mb-4 dark:text-gray-400">Follow sellers from their gigs to see their activity here.</p>
            <Link href="/gigs" className="text-orange-600 font-semibold hover:text-orange-700 dark:text-orange-400 dark:hover:text-orange-300">
              Browse Gigs &rarr;
            </Link>
          </div>
        )}
