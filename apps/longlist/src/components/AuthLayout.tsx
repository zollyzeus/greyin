 ...
 * background wash) so it still reads as Longlist, not a generic form.
...
export function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-amber-50 via-white to-stone-50 dark:from-gray-950 dark:via-gray-950 dark:to-gray-900">
      <div className={wide ? 'max-w-2xl w-full' : 'max-w-md w-full'}>
        <div className="text-center mb-8">
          <a
            href="https://greyin.net"
            className="inline-flex items-center gap-2 text-2xl font-bold text-amber-700 dark:text-amber-400"
          >
