        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form action="/auth/login" method="POST" className="space-y-6">
            ...
            <div className="flex items-center justify-end">
              <Link href="/reset-password" className="text-sm font-medium text-amber-700 hover:text-amber-500">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to Longlist?</span>
              </div>
            </div>
