    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Your Future Roles</h1>
        ...
        {roles && roles.length > 0 ? (
          <div className="space-y-3">
            {roles.map((r: any) => (
              <div key={r.id} className="bg-white rounded-xl border border-gray-200 p-5 flex items-center justify-between gap-4 flex-wrap">
                <div>
                ...
                <div className="flex items-center gap-3">
                  <Link href={`/employer/roles/${r.id}/candidates`} className="inline-flex items-center gap-1.5 text-sm font-semibold text-amber-700 hover:text-amber-800">
          ...
          <p className="text-gray-500">You haven&rsquo;t posted a future role yet.</p>
        )}
      </div>
    </div>
  )
