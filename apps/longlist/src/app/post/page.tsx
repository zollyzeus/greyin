    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-lg mx-auto px-4 py-16 text-center">
          <h1 className="text-xl font-bold text-gray-900 mb-3">Set up your company first</h1>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Post a Future Role</h1>
        ...
        <form action="/api/future-roles/create" method="POST" className="bg-white rounded-xl border border-gray-200 p-7 space-y-5">
          <div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">When do you expect to hire?</label>
          ...
          <div>
            ...
            <input name="skills" type="text" placeholder="e.g. Kubernetes, team leadership, fintech"
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500" />
            <p className="text-xs text-gray-500 mt-1">Separate with commas -- this drives AI matching</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 items-end">
            ...
            <label className="flex items-center gap-2 pb-2.5">
              <input name="is_remote" type="checkbox" value="true" className="w-4 h-4 text-amber-700 rounded focus:ring-amber-500" />
