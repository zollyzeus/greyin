...
export const metadata = {
  title: 'Longlist - Future roles, quietly explored',
  description: 'Companies post roles they expect to open 3-12 months from now, anonymously. Subscribe as future-interested, or let AI surface you to a role that fits where your career is headed.',
}
