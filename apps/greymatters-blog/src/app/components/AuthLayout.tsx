 ...
 * background wash) so it still reads as GreyMatters, not a generic form.
...
export function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-sky-50 via-white to-cyan-50 dark:from-gray-950 dark:via-gray-950 dark:to-gray-900">
      <div className={wide ? 'max-w-2xl w-full' : 'max-w-md w-full'}>
        <div className="text-center mb-8">
          <a
            href="https://greyin.net"
            className="inline-flex items-center gap-2 text-2xl font-bold text-sky-600 dark:text-sky-400"
          >
