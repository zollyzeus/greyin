        ...
        <div className="flex items-center justify-between px-4 h-14 border-b border-gray-200 dark:border-gray-800 shrink-0">
          <div className="flex items-center gap-1">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm font-medium ${tab === 'feedback' ? 'bg-sky-50 text-sky-700 dark:bg-sky-950/40 dark:text-sky-400' : 'text-gray-600 dark:text-gray-400'}`}
            >
              Feedback
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm font-medium ${tab === 'wishlist' ? 'bg-sky-50 text-sky-700 dark:bg-sky-950/40 dark:text-sky-400' : 'text-gray-600 dark:text-gray-400'}`}
            >
              Wishlist
            </button>
          </div>
            ...
            <>
              <form onSubmit={submitFeedback} className="space-y-3 mb-6">
                ...
                <button
                  ...
                  className="bg-sky-600 text-white px-4 py-2 rounded-lg hover:bg-sky-700 font-semibold text-sm disabled:opacity-50"
                >
                ...
                <div className="space-y-3">
                  ...
                  {myFeedback.map((f) => (
                    <div key={f.id} className="border border-gray-200 rounded-lg p-3 dark:border-gray-800">
                      ...
                      {f.admin_reply && (
                        <div className="mt-2 pl-3 border-l-2 border-sky-200 text-sm text-gray-700 dark:border-sky-900 dark:text-gray-300">
                          <p className="font-medium text-sky-700 dark:text-sky-400 text-xs mb-0.5">Team reply</p>
                          {f.admin_reply}
                        </div>
                      )}
                    </div>
                      ...
                      <div key={r.id} data-testid="wishlist-item" className="flex items-start gap-3 border border-gray-200 rounded-lg p-3 dark:border-gray-800">
                        <button
                          ...
                          className={`flex flex-col items-center gap-0.5 px-2.5 py-1.5 rounded-lg border text-xs font-semibold shrink-0 ${
                            upvoted ? 'bg-sky-50 border-sky-300 text-sky-700 dark:bg-sky-950/40 dark:border-sky-800 dark:text-sky-400' : 'border-gray-200 text-gray-600 dark:border-gray-800 dark:text-gray-400'
                          }`}
                        >
