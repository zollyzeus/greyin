...
import { resolveNotificationHref } from '@/app/lib/notification-link'
            ...
            <div className="flex items-center justify-between px-4 py-2 border-b dark:border-gray-800">
              ...
              {unreadCount > 0 && (
                <button
                  ...
                  className="text-xs font-medium text-sky-600 dark:text-sky-400 hover:opacity-80"
                >
                  Mark all read
                </button>
              )}
            ...
            {items.length > 0 ? (
              <div className="divide-y dark:divide-gray-800 max-h-96 overflow-y-auto">
                {items.map((n) => {
                  ...
                  const body = (
                    <div className={`px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 ${n.read ? '' : 'bg-sky-50/60 dark:bg-sky-950/20'}`}>
