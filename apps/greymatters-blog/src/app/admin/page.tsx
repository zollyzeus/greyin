...
import { BookOpen, ArrowLeft, ShieldCheck, Send, Sparkles } from 'lucide-react'
              ...
              {comments.map((comment) => (
                <div key={comment.id} className="py-3 flex items-center justify-between gap-4">
                  ...
                  <form action="/api/admin/comments/delete" method="POST">
                    ...
                    <button type="submit" className="text-sm font-medium text-red-600 hover:text-red-700 whitespace-nowrap">
                      Delete
                    </button>
                  </form>
                </div>
