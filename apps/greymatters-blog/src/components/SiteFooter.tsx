...
// dashboard, login, etc.) had none. Mounted once in layout.tsx instead of
// per-page. Enriched to match the other pillars' footer shape (nav links
// + cross-pillar row) while keeping the original RSS link -- the
    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-white">GreyMatters</span>
            </div>
            <p className="text-sm">Insights, stories, and expertise from the Greyin community.</p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/rss.xml" className="hover:text-white transition">RSS Feed</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-3 text-sm border-t border-gray-800 mt-6 pt-6">
          ...
          <a href="https://greyin.net/contact?app=greymatters" className="hover:text-white transition">Contact</a>
        </div>
      </div>
    </footer>
  )
