  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Link href="/" className="flex items-center text-gray-600 hover:text-indigo-600 mb-6 dark:text-gray-400">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-6 text-gray-700 dark:bg-gray-900 dark:text-gray-300">
          <section>
            <h2 className="font-semibold text-gray-900 mb-2 dark:text-gray-50">Using DeepEdge</h2>
            <p>
          ...
          <section>
            ...
            <p>
              Reach out via <Link href="/enterprise-contact" className="text-indigo-600 hover:underline dark:text-indigo-400">our contact form</Link> with
