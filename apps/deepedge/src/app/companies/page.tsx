  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-6 dark:text-gray-50">Companies Hiring</h1>
        ...
        {companies && companies.length > 0 ? (
            ...
            {companies.map((company) => (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-14 h-14 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0 dark:bg-gray-800">
                    {company.logo_url ? (
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-50">{company.name}</h3>
                    {company.industry && <p className="text-sm text-gray-500 dark:text-gray-400">{company.industry}</p>}
                  </div>
                </div>
                {company.description && (
                  <p className="text-sm text-gray-600 line-clamp-2 mb-3 dark:text-gray-400">{company.description}</p>
                )}
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center dark:bg-gray-900">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2 dark:text-gray-50">No companies yet</h3>
            <p className="text-gray-600 dark:text-gray-400">Check back soon as employers join the platform</p>
          </div>
        )}
      </div>
    </main>
