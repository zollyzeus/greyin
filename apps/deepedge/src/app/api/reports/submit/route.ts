...
// Generic across every content_type this app can report (152) --
// content_reports' own RLS/RPC is the real enforcement; this route just
// redirects back to wherever the report was filed from with a
// friendly banner either way.
