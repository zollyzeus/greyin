      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm text-center text-2xl tracking-[0.5em] focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                placeholder="000000"
              />
            </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link href="/reset-password" className="text-indigo-600 hover:text-indigo-500 font-medium">
              Request a new one
            </Link>
          </p>
        </div>
