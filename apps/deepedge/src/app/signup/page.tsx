...
export default async function SignupPage({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-slate-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl w-full">
        {/* Logo */}
        <div className="text-center mb-8">
          <a href="https://greyin.net" className="inline-flex items-center gap-2 text-3xl font-bold text-indigo-600">
            <Briefcase className="w-8 h-8" />
            <span>DeepEdge</span>
          </a>
          <h2 className="font-display mt-4 text-2xl font-semibold text-gray-900">Create your account</h2>
          <p className="mt-2 text-sm text-gray-600">Join the professional network</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <label className="relative flex flex-col items-center justify-center p-6 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-indigo-500 hover:bg-indigo-50 transition-all">
              <input
                type="radio"
                name="role"
                value="employer"
              ...
              />
              <Building2 className="w-12 h-12 text-gray-400 peer-checked:text-indigo-600 mb-3" />
              <span className="text-lg font-medium text-gray-700 peer-checked:text-indigo-600">
                Hire Talent
              </span>
              <span className="text-sm text-gray-500 mt-1">Post jobs & find candidates</span>
            ...
            <label className="relative flex flex-col items-center justify-center p-6 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-indigo-500 hover:bg-indigo-50 transition-all">
              <input
                ...
                className="sr-only peer"
              />
              <User className="w-12 h-12 text-gray-400 peer-checked:text-indigo-600 mb-3" />
              <span className="text-lg font-medium text-gray-700 peer-checked:text-indigo-600">
                Find Jobs
              </span>
              <span className="text-sm text-gray-500 mt-1">Apply to opportunities</span>
              <div className="absolute inset-0 border-2 border-transparent peer-checked:border-indigo-600 rounded-xl pointer-events-none" />
            </label>
          </div>
        </div>
