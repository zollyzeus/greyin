  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Back button */}
        <Link href="/jobs" className="flex items-center text-gray-600 hover:text-blue-600 mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
                ...
                <div className="flex-1">
                  <h1 className="text-3xl font-bold text-gray-900 mb-2">
                    ...
                    {job.open_to_career_changers && (
                      <span className="ml-2 align-middle px-2 py-0.5 bg-orange-50 text-orange-700 rounded-full text-xs font-medium">
                        Open to career changers
                      </span>
                    )}
                    {job.open_to_reentry && (
                      <span className="ml-2 align-middle px-2 py-0.5 bg-blue-50 text-blue-700 rounded-full text-xs font-medium">
                        Open to candidates with career gaps
                      </span>
                    )}
                  </h1>
                  {job.companies?.id ? (
                    <Link href={`/companies/${job.companies.id}`} className="text-xl text-gray-600 hover:text-blue-600 mb-4 inline-block">
                      {job.companies.name}
                    </Link>
                  ) : (
              ...
              <div className="mt-6 flex gap-4">
                ...
                <a href="#refer" className="border border-gray-300 px-6 py-3 rounded-lg hover:bg-gray-50 font-semibold flex items-center gap-2">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              {job.benefits && (
                <>
                  <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Benefits</h3>
                  <div className="prose max-w-none text-gray-700 whitespace-pre-line">
                    {job.benefits}
                  </div>
                </>
              ...
              <div className="bg-white rounded-lg shadow-md p-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {job.skills_required.map((skill: string) => (
                    <span key={skill} className="px-4 py-2 bg-blue-50 text-blue-700 rounded-lg text-sm font-medium">
                      {skill}
                    </span>
                  ))}
                </div>
          ...
          <div className="space-y-6">
            ...
            {/* Refer a Friend */}
            <div id="refer" className="bg-white rounded-lg shadow-md p-6">
              <h3 className="font-bold text-lg mb-1 flex items-center gap-2">
                <UserPlus className="h-5 w-5 text-blue-600" />
                Know someone great for this?
              </h3>
              <p className="text-sm text-gray-600 mb-4">Refer a fellow professional — we'll let them know.</p>
              ...
              <form action={`/api/jobs/${job.id}/refer`} method="POST" className="space-y-3">
                ...
                <textarea
                  ...
                  className="block w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                />
                <button type="submit" className="w-full border border-blue-600 text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50 font-semibold text-sm">
                  Send Referral
                </button>
              </form>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              {job.companies?.id && (
                <Link
                  ...
                  className="block w-full mt-6 border border-blue-600 text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50 font-semibold text-center"
                >
