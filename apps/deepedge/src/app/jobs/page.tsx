    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-cyan-600 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form id="job-filters" action="/jobs" method="GET" className="bg-white rounded-lg p-4 flex gap-4">
            ...
            <div className="flex items-center gap-3 border-l pl-4">
              ...
              <input
                ...
                className="outline-none text-gray-900 placeholder-gray-500 w-48"
              />
            </div>
        ...
        <div className="flex gap-8">
          ...
          <aside className="w-64 flex-shrink-0">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              ...
              <div className="mb-6">
                <h3 className="font-semibold text-sm text-gray-900 mb-3">Minimum Experience</h3>
                <select
                  form="job-filters"
                  name="min_experience"
              ...
              <div className="mb-6">
                <h3 className="font-semibold text-sm text-gray-900 mb-3">Work Location</h3>
                <div className="space-y-2">
                  {[
              ...
              <div className="mb-6">
                <h3 className="font-semibold text-sm text-gray-900 mb-3">Cross-pillar tracks</h3>
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input
                      ...
                      className="rounded text-indigo-600 mr-2"
                    />
                    <span className="text-sm text-gray-700">Open to career changers</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                      ...
                      className="rounded text-indigo-600 mr-2"
                    />
                    <span className="text-sm text-gray-700">Open to candidates with career gaps</span>
                  </label>
                </div>
              </div>
              ...
              <Link href="/jobs" className="block w-full text-center text-sm text-indigo-600 hover:text-indigo-700 font-semibold">
                Reset Filters
              </Link>
            </div>
          </aside>
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <Link href={`/jobs/${job.id}`} className="flex gap-4 flex-1">
                        ...
                        {/* Job Info */}
                        <div className="flex-1">
                          <h3 className="text-xl font-semibold text-gray-900 mb-1 hover:text-indigo-600">
                            {job.title}
