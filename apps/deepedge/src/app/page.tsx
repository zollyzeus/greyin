    ...
    <main className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <h1 className="font-display text-5xl md:text-6xl font-semibold text-gray-900 mb-6">
            ...
            <span className="text-indigo-600"> auto-reject</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="bg-white text-indigo-600 border-2 border-indigo-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-indigo-50 transition flex items-center justify-center"
            >
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            <div className="text-4xl font-bold text-indigo-600 mb-2">{jobCount ?? 0}</div>
            <div className="text-gray-600">Open Jobs</div>
          </div>
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            <div className="text-4xl font-bold text-indigo-600 mb-2">{companyCount ?? 0}</div>
            <div className="text-gray-600">Companies</div>
          </div>
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            <div className="text-4xl font-bold text-indigo-600 mb-2">{candidateCount ?? 0}</div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-16">Why Choose DeepEdge?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6">
              ...
              <p className="text-gray-600">Our AI-powered algorithm matches candidates with the perfect job opportunities based on skills, experience, and preferences.</p>
            </div>
            <div className="p-6">
              <div className="bg-indigo-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">All companies on our platform are verified to ensure authenticity and provide a secure hiring experience.</p>
            </div>
            <div className="p-6">
              <div className="bg-indigo-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                <Users className="h-6 w-6 text-indigo-600" />
              </div>
              <h3 className="text-xl font-semibold mb-2">A Verified Expert Pool</h3>
              <p className="text-gray-600">Every searchable candidate has cleared the Verified Expert bar — senior-level experience, or a real track record on StackWorks, FlexPro, or Salt &amp; Pepper — not a self-reported resume.</p>
            </div>
            <div className="p-6">
              <div className="bg-indigo-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">Create and publish job listings in minutes with our intuitive interface and comprehensive templates.</p>
            </div>
            <div className="p-6">
              <div className="bg-indigo-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">Streamlined application process allows candidates to apply to multiple positions quickly and efficiently.</p>
            </div>
            <div className="p-6">
              <div className="bg-indigo-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">Showcase your company culture, values, and benefits with rich, engaging company profiles.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Three ways to work with DeepEdge</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link href="/solutions" className="block bg-gray-50 rounded-2xl p-8 hover:shadow-md transition-shadow">
              <Search className="h-8 w-8 text-indigo-600 mb-4" />
              <h3 className="text-lg font-bold text-gray-900 mb-2">Age-Blind Candidate Search</h3>
              <p className="text-gray-600 text-sm">Self-serve subscription access to the Verified Expert pool.</p>
            </Link>
            <Link href="/solutions" className="block bg-gray-50 rounded-2xl p-8 hover:shadow-md transition-shadow">
              <Users2 className="h-8 w-8 text-teal-600 mb-4" />
              <h3 className="text-lg font-bold text-gray-900 mb-2">Fractional Leadership Placement</h3>
              <p className="text-gray-600 text-sm">A Verified Expert leader, a few days a week, sales-led.</p>
            </Link>
            <Link href="/solutions" className="block bg-gray-50 rounded-2xl p-8 hover:shadow-md transition-shadow">
              <LifeBuoy className="h-8 w-8 text-orange-600 mb-4" />
              <h3 className="text-lg font-bold text-gray-900 mb-2">Outplacement</h3>
              <p className="text-gray-600 text-sm">Support departing employees straight into the ecosystem.</p>
            </Link>
          </div>
        </div>
      </section>

      {/* Ecosystem discovery now lives on the hub (greyin.net) -- this app
          is the DeepEdge marketplace specifically, at
          deepedge.greyin.net. A single link back is enough; the "More
          Platforms" dropdown in SiteHeader also covers this. */}
      <section className="py-16 bg-gradient-to-b from-gray-50 to-white text-center">
        <p className="text-gray-600">
          Part of the{' '}
          <a href="https://greyin.net" className="text-indigo-600 font-semibold hover:text-indigo-700">
            Greyin ecosystem
          </a>{' '}
          — GreyMatters, Salt &amp; Pepper, FlexPro, and StackWorks.
        </p>
      </section>
