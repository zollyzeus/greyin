      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {items && items.length > 0 ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <p className="text-gray-600 mb-4">Browse companies and jobs to find people to follow.</p>
            <Link href="/companies" className="text-blue-600 font-semibold hover:text-blue-700">
