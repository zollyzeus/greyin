    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Have a say in the eligibility bar</h1>
        </div>
        ...
        {myScore && (
          <p className="flex items-center gap-1 text-sm font-semibold mb-8 text-indigo-700">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="font-semibold text-gray-900 mb-1">Current live threshold</h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <form action="/api/governance/threshold-vote" method="POST" className="space-y-5">
            <div>
              <label htmlFor="proposed_years" className="block text-sm font-medium text-gray-700">
            ...
            <div>
              <label htmlFor="proposed_score" className="block text-sm font-medium text-gray-700">
